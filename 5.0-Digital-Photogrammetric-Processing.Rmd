...
```{r, echo=FALSE, out.width="100%",fig.align = 'center', fig.cap="Key point and Tie point matching [30]."}
...
```{r, echo=FALSE, out.width="100%",fig.align = 'center', fig.cap="A cross-section of a DAP point cloud in a planted spruce forest."}
