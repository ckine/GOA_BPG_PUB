...
```{r, echo=FALSE, out.width="100%",fig.align = 'center', fig.cap="A visualization of the process of normalizing terrain."}
...
```{r, echo=FALSE, out.width="100%",fig.align = 'center', fig.cap="DAP point cloud normalization with DEM derived from a co-occurring LiDAR point cloud [30]."}
